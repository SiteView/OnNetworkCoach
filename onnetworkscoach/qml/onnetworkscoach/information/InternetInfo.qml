...
Rectangle {
    ...
    width: mainWindow.width - categoryButtons.width; height:500
    color: "white"

    Flickable {
        id: flickable1; x: 10

        width: container.width ; height: middleWindow.height - buttonRect.height
        //anchors.fill: parent
        contentWidth: childRect.width; contentHeight: childRect.height
        ...
        Column {
            ...
            Column {
                id: column0; spacing: 15

                TextInfo { id: text1; textInfo: "Does your Internet connection require a login?";
                ...
                Grid {
                    id: position0
                    columns: 2; spacing:15  /*rowSpacing: 15*/
                ...
                TextInfo { id: text8; textInfo: "Internet IP Address";
                    font.bold: true; color: "green" }
                Row {
                    CheckBox {
                ...
                Image { width: container.width; height: 1; source: "../images/liteblue.gif"; smooth: true }
                TextInfo { id: text14; textInfo: "Domain Name Server (DNS) Address";
                    font.bold: true; color: "green" }
                Row {
                    CheckBox {
                ...
                Image { width: container.width; height: 1; source: "../images/liteblue.gif"; smooth: true }
                TextInfo { id: text20; textInfo: "Router MAC Address";
                    font.bold: true; color: "green" }
                Row {
                    CheckBox {
                        id: check6
    ...
    // 滚动条
    Rectangle {
        id: scrollbar; width: 17; height: flickable1.height
        ...
        Image {
            ...
            MouseArea {
                ...
                hoverEnabled: true
                onEntered: button.opacity = .6
                onExited: button.opacity = .4
                onPressed: button.opacity = .8
            }
        }
    ...
    Rectangle {
        ...
        width: container.width; height: 20
        anchors.bottom: container.bottom
        z: 1
    }

    Column {
        id: fixPart; spacing: 15; z: 1
        anchors { right: container.right; rightMargin: scrollbar.width ; bottom: buttonRect.bottom }
        //three buttons
        Row {
